...
| Keyword + category combined | Both match | `"Nguyễn Minh Đức"` + `"Công nghệ"` | Display 2 books: BOOK001, BOOK009 |
...
| TC-04-03 | Borrow a lost book | 1. Member can log in<br>2. Member is active<br>3. Book is lost<br>4. Member's borrow count is less than 3<br>5. Display language: Vietnamese/English | 1. Refresh the page<br>2. Log in to the account of MEM002<br>3. Borrow the book BOOK007 | 1. Login email: ba.nguyen@email.com<br>2. Login password: password123<br>3. Book borrowed: BOOK007 | - Member cannot borrow the book<br>- Display the book status is "Lost" in corresponding display language<br>- Program state remains unchanged | REQ-04 | EP, Decision Table |
